...
namespace StudentManagementL1.Controllers
{
    public class SpecializationsController : Controller
    {
        ...
        public SpecializationsController(StudentContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Description")] Specialization specialization)
        {
